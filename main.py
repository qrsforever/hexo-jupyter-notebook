...
def main(asset_dir, jupyter_file, inc_height):
    ...
    restr = restr.replace('href=', 'target="_blank" rel="noopener" href=')
    # print(restr)
    # 使用2.0.3高度计算会重新刷新
    # <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script>
    template = """
<script src="/js/jquery.min.js"></script>
<iframe id="ipynb-%d" marginheight="0" marginwidth="0" frameborder="0" height="100%%" width="100%%" scrolling="no" srcdoc="%s">
</iframe>
<script>
...
document.getElementById('ipynb-%d').height= h + %s;
    ...
    # why sub: <a>导致notebook显示不全
    ## ./hexo/lib/plugins/filter/after_render/external_link.js
